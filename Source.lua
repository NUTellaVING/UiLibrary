...
local Library = {
	Theme = {
		Accent = Color3.fromRGB(0, 158, 255),
...
local SelfModules = {
	UI = loadstring(game:HttpGet("https://raw.githubusercontent.com/NUTellaVING/UiLibrary/main/Ui.lua"))(),
	Directory = loadstring(game:HttpGet("https://raw.githubusercontent.com/NUTellaVING/UiLibrary/main/Directory.lua"))(),
}
